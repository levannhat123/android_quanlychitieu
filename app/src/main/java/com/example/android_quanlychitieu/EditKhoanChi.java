...
public class EditKhoanChi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        khoanThuId = getIntent().getIntExtra("khoanchi_id", -1);
    ...
    private void setupDatePicker() {
        ...
        edtNgayThu.setOnClickListener(v -> new DatePickerDialog(EditKhoanChi.this, dateSetListener,
    ...
    private void loadKhoanThuData() {
        ...
        edtName.setText(khoanThu.getTenKhoanChi());
        edtNgayThu.setText(khoanThu.getNgayChi());
        ...
        for (int i = 0; i < loaiThuList.size(); i++) {
            if (loaiThuList.get(i).getId() == khoanThu.getLoaiChiId()) {
